...
void instrumentert::instrument_with_strategy(instrumentation_strategyt strategy)
{
  ...
  else if(num_sccs!=0)
  {
    ...
    message.debugx() << "no cycles to instrument" << messaget::eom;
}
  ...
  const std::set<event_grapht::critical_cyclet>& set_of_cycles)
{
  ...
  */
  ...
  message.debugx() << "edges: "<<edges.size()<<" cycles:"<<set_of_cycles.size()
    << messaget::eom;
  ...
  message.debugx() << "size of the system: " << mat_size
    << messaget::eom;
